...
<br>
例１、各種制限を考慮せず無邪気な例 <button onclick="Efw('helloTextCSVThread_submit',{mode:'1'})">Run1</button> <button onclick="Efw('helloTextCSVThread_submit2',{mode:'1'})">Run2</button><br>
例２、１件ずつ処理の慎重派の例 <button onclick="Efw('helloTextCSVThread_submit',{mode:'2'})">Run1</button> <button onclick="Efw('helloTextCSVThread_submit2',{mode:'2'})">Run2</button><br>
