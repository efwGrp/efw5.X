 ...
 */
class EfwClientChartJS{
	constructor(chartId,dataId,type,version,setOptions){
		...
		if(formatter){
			if(types[this.#type].axis=="v"){
				this.#options.scales.y.ticks.callback=function(value, index, values) {
					return EfwClientFormat.formatNumber(value,formatter);
				}
				this.#options.plugins.tooltip.callbacks.label=function(context){
					return context.dataset.label+": "+EfwClientFormat.formatNumber(context.parsed.y,formatter);
				}
			}else if(types[this.#type].axis=="h"){
				...
				this.#options.plugins.tooltip.callbacks.label=function(context){
					return context.dataset.label+": "+EfwClientFormat.formatNumber(context.parsed.x,formatter);
				}
			}else if(types[this.#type].axis=="r"){
				...
				this.#options.plugins.tooltip.callbacks.label=function(context){
					return context.label+": "+EfwClientFormat.formatNumber(context.parsed,formatter);
				}
			}
		}
