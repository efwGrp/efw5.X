...
| `type` | Yes |  | The type of chart. [Demo](https://efwgrp.github.io/efw5.X/help/chart/chartSampleTypes.html). |
...
| `data-color` | No |  | The color of items. Set with RGB or color names in row or column titles. [Demo](https://efwgrp.github.io/efw5.X/help/chart/chartSampleColors.html).<br>![Data Table](../img/chart/table.png)![Chart 1](../img/chart/chart1.png)![Chart 2](../img/chart/chart2.png) |
